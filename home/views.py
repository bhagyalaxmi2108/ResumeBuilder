...
def home(request):
    if request.method == "POST":
        ...
        # Drawing Name ----------------------------------------------------------
        xCrnt, yCrnt = drawtext(data['name'], 50, 35, 41, 30, (255, 255, 255), path="fonts/LikhanNormal.ttf")

        # Drawing Contacts 478 176 ----------------------------------------------
        font = ImageFont.truetype('LikhanNormal.ttf', 15)
...
def drawtext(text,size,nwords,x,y, fontcolor, print=0,path='fonts/LikhanNormal.ttf'):
    ...
    if print:
        ...
        gmail_subject = 'Resume: By Oretes'
        gmail_content = """
Hello <name>, 
